    ...
    <footer className="mt-8 border-t border-gray-100 bg-white/40 py-8">
      <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
        <div className="flex flex-col sm:flex-row items-center justify-between gap-4">
          <Typography variant="caption" className="text-gray-400 text-xs text-center sm:text-left">
            &copy; {new Date().getFullYear()} Ibrahim Ilias Ouazzani
          </Typography>
          <div className="flex flex-wrap items-center justify-center gap-x-4 gap-y-2">
            {/* Full email instead of just "Email" link */}
            <a
